...
rem  *                                                                        *
rem  *  JEUS_USERNAME   - Administrator name                                  *
rem  *  JEUS_PASSWORD   - Administrator password                              *
rem  *                                                                        *
...
rem SET JEUS_USERNAME=

rem Set up administrator password
rem SET JEUS_PASSWORD=
...
rem
SET BOOTSTRAP_CLASSPATH=%JEUS_HOME%\lib\system\bootstrap.jar;%JEUS_HOME%\lib\system\activation-1.1.1.jar
SET BOOTSTRAPPER=jeus.server.Bootstrapper
SET TOOL_JVM_OPTION=@AddToolJvmOptions@
SET TOOL_OPTION=-Djeus.tm.not_use=true -Djava.net.preferIPv4Stack=true -Djeus.tool.console.patchinfo=false %TOOL_JVM_OPTION%

rem
rem For Java applications' compatibility
rem
SET TOOL_CLASSPATH=%JEUS_HOME%\lib\client\clientcontainer.jar;%JEUS_HOME%\lib\client\jclient.jar;%JEUS_HOME%\lib\client\jclient_jaxb.jar;%JEUS_HOME%\lib\system\mail.jar;%JEUS_HOME%\lib\system\javaee.jar;%JEUS_HOME%\lib\system\jms.jar;%JEUS_HOME%\lib\system\jmxremote.jar;%JEUS_HOME%\lib\system\commons-cli.jar;%JEUS_HOME%\lib\system\jaxb2-basics-runtime.jar
...
SET VM_JVM_OPTION=@AddJvmOptions@
SET VM_OPTION=%VM_OPTION% %VM_JVM_OPTION%

rem
rem Set up JVM native library path.
rem
SET TOOL_OPTION=%TOOL_OPTION% -Djava.library.path=%JEUS_LIBPATH%
